...
public class BankAppController {
	...
	public String deposit(@ModelAttribute Transaction transaction, Model model) {
		restTemplate.postForEntity("http://localhost:8979/transactions", transaction, null);
	...
	public String fundTransfer(@RequestParam("senderAccountNo") int senderAccountNo, @RequestParam("receiverAccountNo") int receiverAccountNo,
		...
		restTemplate.postForEntity("http://localhost:8979/transactions/withdraw", senderTransaction, null);
		Transaction receiverTransaction = new Transaction(receiverAccountNo, amount);
		restTemplate.postForEntity("http://localhost:8979/transactions", receiverTransaction, null);
		model.addAttribute("message","Success!");
		return "fundTransfer";
	}
	...
	public String withdraw(@ModelAttribute Transaction transaction, Model model) {
		restTemplate.postForEntity("http://localhost:8979/transactions/withdraw", transaction, null);
		model.addAttribute("message","Success!");
		return "Withdraw";
	}
	...
	public ModelAndView getStatement(@RequestParam("offset") int offset, @RequestParam("size") int size) {
		...
		CurrentDataSet currentDataSet = restTemplate.getForObject("http://localhost:8979/transactions", CurrentDataSet.class);
